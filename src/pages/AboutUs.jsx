...
const AboutUs = () => {
  ...
  return (
    <div className="bg-mainBackgroundColor font-poppins flex flex-col items-center justify-center h-full m-auto">
      {/** About Us */}
      <motion.span
      ...
      >
        ...
        <p>
          ...
          doesn’t rely on monthly service fees, or minimum balance requirements.
        </p>
      </motion.div>
        ...
        <div className="flex">
          <ul className="sm:ml-8 md:ml-11 sm:py-8 md:py-11 py-6 ml-4 list-disc">
            <li className="sm:py-3 md:py-4 py-2">
              ...
              Explore all the malls in your area with just a few clicks. Whether
              you're looking for the latest fashion trends, the best dining
              options, or the newest entertainment spots, MallEZ has got you
              covered.
            </li>
            <li className="sm:py-3 md:py-4 py-2">
              <span className="sm:px-2 px-1 font-bold">
            ...
            <li className="sm:py-3 md:py-4 py-2">
              ...
              ensures you find your way to your desired shop or facility without
              any hassle.
            </li>
            <li className="sm:py-3 md:py-4 py-2">
              <span className="sm:px-2 px-1 font-bold">
              ...
              system, which makes transactions faster, easier, and more secure.
            </li>
            <li className="sm:py-3 md:py-4 py-2">
              <span className="sm:px-2 px-1 font-bold">
      ...
      >
        ...
        <p>
          ...
          focus on customer convenience and innovative technology, we’re setting
          a new standard in the shopping industry.
        </p>
